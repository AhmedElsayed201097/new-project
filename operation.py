...
# 3.BQ table Name
output_table_esim_thales_Operational = 'vf-grp-cpsa-pprd-cpsoi-10.esim.thales_operational'
...
with DAG('eSIM-thales-operational-service1', description='DAG for deployment a Dataproc Cluster',
    ...
    init_actions_uris =['gs://goog-dataproc-initialization-actions-us-central1/connectors/connectors.sh',
                        'gs://goog-dataproc-initialization-actions-us-central1/python/pip-install.sh']).make()
...
create_cluster >> bq_delete_existing_partitionData >> submit_pyspark_thales_operational >> delete_cluster >> delete_transformed_files_thales_operational